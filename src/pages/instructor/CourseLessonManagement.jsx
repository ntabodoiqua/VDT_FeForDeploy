...
const CourseLessonManagement = () => {
    ...
    useEffect(() => {
        const loadCourses = async () => {
            if (!auth.username) return; // Don't load if username is not available
        ...
        loadCourses();
    }, [coursePagination.current, coursePagination.pageSize, auth.username]);
    ...
    useEffect(() => {
        if (isAddLessonModalVisible && auth.username) {
    ...
    }, [isAddLessonModalVisible, allLessonsModalPagination.current, allLessonsModalPagination.pageSize, auth.username]);
